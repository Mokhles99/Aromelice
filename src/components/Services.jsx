...
export default function Services() {
    ...
    return (
      ...
      >
        ...
        <div className="lg:w-4/5 mx-auto mt-8 flex flex-col items-center">
          ...
          <button className="flex items-center gap-3 bg-[#9A3E87] w-full py-2 text-white justify-center text-sm transition-bg hover:bg-black hover:text-white">
            BOOK NOW
  ...
  const Product = ({ image, name }) => {
    return (
      ...
      >
        ...
        <button className="bg-[#D03EB2] px-7 py-2 text-xs font-bold text-white transition-bg hover:bg-main hover:text-white">
          ADD TO CART
        </button>
      </div>
    );
  ...
  return (
    <div>
      <section
        className="bg-[url('/slider-3-bg-111.png')] bg-no-repeat bg-center bg-cover flex flex-col justify-center items-center lg:pt-24 pt-8"
        data-aos="zoom-in-down"
        data-aos-delay="300"
      >
        <img src="/aromelicelogo.png" alt="" className="mb-4" width={120} />
      ...
      >
        ...
        <div className="bg-[#315725] flex flex-col justify-center items-start text-white px-16 lg:py-0 py-8 lg:w-1/3">
