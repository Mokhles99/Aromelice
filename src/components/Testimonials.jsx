...
export default function Testimonials() {
  ...
  return (
    <div>
      <section className="bg-[url('/slider-3-bg-111.png')] bg-no-repeat bg-center bg-cover py-20">
        <div className="max-w-[1200px] mx-auto xl:px-0 px-6 lg:flex gap-8">
          <div className="lg:w-1/3" data-aos="fade-right" data-aos-delay="300">
            <img src="/aromelicelogo.png" width={120} alt="" className="mb-4" />
            <h4 className="lg:text-[40px] text-[30px] text-[#9A3E87] font-medium leading-[1.2em]">
              Our testimonials
            </h4>
            ...
            <p className="text-[15px] mb-7">
              ...
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto debitis iste tenetur asperiores. Fugit, quos nostrum cumque ipsam enim doloribus iure eius fuga debitis repudiandae molestias voluptatibus magni placeat odit.
            </p>
              ...
              <div className="relative lg:flex h-full py-20 items-center">
                <div className="lg:absolute lg:max-w-[500px] z-20">
                  <div className="bg-white p-[10px] w-full h-full offer_card bg-[url('/testi-3-shape-bg.png')] bg-no-repeat bg-right-top">
                    ...
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolorem quam dignissimos tempora dolore. Repellendus inventore architecto culpa nemo labore excepturi, consequatur voluptatum nesciunt, assumenda qui natus quos quisquam harum fugiat.
                    </p>
                  </div>
                </div>
